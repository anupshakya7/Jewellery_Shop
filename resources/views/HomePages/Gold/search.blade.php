...
<div class="container py-5">
    <div class="row">
        <div class="col-md-12">
            <a href="/gold" class="btn btn-danger btn-sm float-end"><- Back</a>
        </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($search_gold_item as $key => $searchgolds)
                            <tr>
                                <td>{{$searchgolds->item_code}}</td>
                                <td>{{$searchgolds->item_name}}</td>
                                <td>{{$searchgolds->item_tola}}</td>
                                <td>
                                    <button type="button" value="{{$searchgolds->id}}" class="btn btn-primary editbtn btn-sm">Edit</button>
                                    <a href="{{route('delete',$searchgolds->id)}}" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
