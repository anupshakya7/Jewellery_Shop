...
<div class="container py-5">
    <div class="row">
        <div class="col-md-12">
            <a href="/silver" class="btn btn-danger btn-sm float-end"><- Back</a>
        </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($search_silver_item as $key => $searchsilver)
                            <tr>
                                <td>{{$searchsilver->item_code}}</td>
                                <td>{{$searchsilver->item_name}}</td>
                                <td>{{$searchsilver->item_tola}}</td>
                                <td>
                                    <button type="button" value="{{$searchsilver->id}}" class="btn btn-primary editbtn btn-sm">Edit</button>
                                    <a href="{{route('delete',$searchsilver->id)}}" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
